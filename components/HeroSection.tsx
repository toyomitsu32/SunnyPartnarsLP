        ...
        >
          ...
          >
            <div className="relative w-32 h-32 mx-auto">
              <div className="absolute inset-0 rounded-full opacity-20 blur-2xl animate-pulse bg-gradient-to-br from-primary-orange to-primary-yellow"></div>
              <img 
                src="/sunny-logo.png" 
